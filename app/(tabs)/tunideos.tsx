...
const Tunideos = () => {
  ...
  return (
    ...
    >
      ...
      <Button title="Tuna A" disabled={hasUserVoted} onPress={() => voteFavoriteTuna('Tuna A')} />
      <Button title="Tuna B" disabled={hasUserVoted} onPress={() => voteFavoriteTuna('Tuna B')} />
      <Button title="Tuna C" disabled={hasUserVoted} onPress={() => voteFavoriteTuna('Tuna C')} />
      <Button title="Tuna D" disabled={hasUserVoted} onPress={() => voteFavoriteTuna('Tuna D')} />
      <Button title="Tuna E" disabled={hasUserVoted} onPress={() => voteFavoriteTuna('Tuna E')} />
      <Button title="Tuna F" disabled={hasUserVoted} onPress={() => voteFavoriteTuna('Tuna F')} />
    </View>
  );
};
